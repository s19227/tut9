...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps
                .Select(e => new { FirstName = e.Ename, EmployeeJob = e.Job });
        }
        ...
        public void Task7()
        {
            var res = Emps
                .GroupBy(e => e.Job)
                .Select(g => new { EmployeeJob = g.Key, EmployeeNuber = g.Count() });
        }
        ...
        {
            var res = Emps
                .Aggregate((highest, current) => current.Salary > highest.Salary ? current : highest);
        }
        ...
        {
            var res = Emps
                .SelectMany(e => Depts, (e, d) => new { e.Empno, e.Ename, EDeptno = e.Deptno, e.Job, e.Mgr, e.Salary, DDeptno = d.Deptno, d.Dname, d.Loc });
        }
    }
}
